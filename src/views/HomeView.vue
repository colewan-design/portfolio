    ...
    <v-container fluid>
        ...
        <v-row>
          ...
          <v-col cols="5">
            <div style="position: relative; z-index: 9999" class="mt-16">
              <v-img src="i1.png" contain max-height="250"></v-img>
            </div>
          </v-col>
        </v-row>
      </div>
        ...
        <div>
          <v-row>
            ...
            <v-col cols="12" sm="6">
              ...
              <h4 class="mt-n4">I Am an Information System Analyst</h4>
              <h4 class="">And Developer</h4>
              <p class="text-grey">
                With a strong background in systems analysis and software development, I specialize in designing
                efficient, scalable, and user-centric information systems. My passion lies in bridging the gap between
                complex business needs and technology by delivering tailored solutions that drive productivity and
                innovation.
              </p>
              <br />
              <p class="text-grey">
                From analyzing workflows and optimizing processes to developing full-stack web applications, I bring a
                versatile skill set to every project I undertake. I am committed to continuous learning and leveraging
                the latest tools and technologies to build systems that make an impact.
              </p>
            ...
            <v-col cols="12">
              <div class="child">
                ...
                <p class="text-grey ml-3 mt-4 text-caption">
                  Crafting modern, responsive, and user-friendly website designs<br />
                  focused on performance, accessibility, and visual impact.<br />
                  Skilled in HTML, CSS, JavaScript, and UI/UX principles.
                </p>
              </div>
              <div class="child">
                <v-btn icon="fas fa-mobile-alt" color="#FBDF7E" class="text-white"></v-btn>
                <h3 class="ml-3 mt-4">System Development</h3>
                <p class="text-grey ml-3 mt-4 text-caption">
                  Developing robust and scalable information systems<br />
                  tailored to business needs, including database management,<br />
                  backend logic, and process automation.
                </p>
              </div>
            </v-col>
      ...
      <v-col cols="12" sm="12" id="services">
        <div class="d-flex justify-center mb-6">
          ...
          <v-btn class="mr-2" variant="tonal">Web System</v-btn>
        </div>
      </v-col>
      ...
      <v-col cols="12" sm="12">
        <div class="d-flex justify-center mb-6">
          <v-btn color="#FBDF7E" class="mt-4"> More Soon</v-btn>
        </div>
      </v-col>
        ...
        <div class="hire">
          <v-row>
            <v-col cols="12" sm="8">
              ...
              <p class="text-grey">
                Whether you're building a custom information system, a responsive web application, or need technical
                consultation, I bring both analytical insight and development expertise to deliver high-quality,
                scalable
                solutions. Let's work together to turn your ideas into reality and take your project to the next level.
              </p>
            </v-col>
            <v-col cols="12" sm="4">
        ...
        <v-row>
          <v-col cols="12" sm="4">
            <div class="child">
              ...
              <span class="text-caption">Loakan, Baguio </span><br />
              <v-btn icon="fas fa-phone-alt" color="" class="mt-10" variant="outlined"></v-btn><br />
              <span class="text-caption">09086753498 </span> <br />
              <v-btn icon="fas fa-envelope" color="" class="mt-10" variant="outlined"></v-btn><br />
              <span class="text-caption">cts.colewan@gmail.com </span> <br />
            </div>
          </v-col>
          <v-col cols="12" sm="8">
            ...
            <span class="text-caption">
              Have a question, project idea, or collaboration in mind? I'm always open to hearing from you. Fill out the
              form
